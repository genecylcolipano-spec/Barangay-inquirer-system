...
<div class="page-header mb-4">
    <div class="row align-items-center">
        ...
        <div class="col-auto">
            <a href="{{ route('superadmin.announcements.edit', $announcement) }}" class="btn btn-warning me-2">
                <i class="fas fa-edit"></i> Edit
            </a>
            <a href="{{ route('superadmin.announcements.index') }}" class="btn btn-outline-secondary">
                Back to List
            </a>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <a href="{{ route('superadmin.announcements.edit', $announcement) }}" class="btn btn-warning btn-sm d-grid mb-2">
                    <i class="fas fa-edit"></i> Edit Content
                </a>

                <form action="{{ route('superadmin.announcements.destroy', $announcement) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this announcement?')">
                    @csrf
                    @method('DELETE')
